...
console.log(div);
dom.after(test, div);
var div2 = dom.create('<div>789</div>');
dom.before(test, div2);
var div3 = dom.create('<p>jirengu</p>');
dom.append(document.body, div3);
var div4 = dom.create('<div id="parent"></div>');
dom.wrap(test, div4); // dom.remove(test)
// const e1 = dom.empty(empty)
// console.log(e1)

dom.attr(test, 'title', 'hello world');
var a = dom.attr(test, 'title');
console.log("title:".concat(a));
dom.attr(test, 'id', 'test1');
dom.text(test1, '你好，这是新的内容');
var t1 = dom.text(test1);
console.log(t1);
dom.style(test1, {
  border: '1px solid red',
  color: 'red'
});
var s = dom.style(test1, 'color');
console.log(s);
dom.style(test1, {
  color: 'green'
});
...
console.log(testDiv);
var test2 = dom.find('#t2')[0];
console.log(dom.find('.red', test2)[0]); // console.log(dom.siblings(dom.find('.e2')[0]))
